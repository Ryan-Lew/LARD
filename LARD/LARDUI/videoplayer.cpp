...
void VideoPlayer::run()
{
    ...
    img_convert_ctx = sws_getContext(pCodecCtx->width, pCodecCtx->height,
            ...
            AV_PIX_FMT_PAL8, SWS_BICUBIC, NULL, NULL, NULL);

    numBytes = avpicture_get_size(AV_PIX_FMT_PAL8, pCodecCtx->width,pCodecCtx->height);

    out_buffer = (uint8_t *) av_malloc(numBytes * sizeof(uint8_t));
    avpicture_fill((AVPicture *) pFrameRGB, out_buffer, AV_PIX_FMT_PAL8,
